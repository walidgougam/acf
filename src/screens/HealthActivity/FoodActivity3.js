...
// export default class EditFoodActivity extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       foodActivity: [],
...
//         getActivityFoodData(
//           ['Mweso-Territoire', 'Kalonda Ouest'],
...
//     };
//     let food_activity_object = {
//       foodActivity: this.state.food,
//     };

//     this.props.navigation.navigate('EditDataAcceptation', {
//       membersFamily,
//       familyData,
//       food_activity: this.state.foodKey.filter((key, index) => {
//         return this.state.chekedActivities[index];
//       }),
//     });
//   };
